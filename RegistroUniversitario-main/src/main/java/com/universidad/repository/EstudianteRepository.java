...
import java.util.Optional; // Asegúrate de importar la clase Optional
...
public class EstudianteRepository {
    ...
    // Método findById que devuelve un Optional<Estudiante>
    public Optional<Estudiante> findById(Long id) {
        return Optional.ofNullable(estudiantes.get(id)); // Retorna un Optional con el estudiante encontrado o vacío
    }
    ...
    public void init() {
        ...
        Estudiante estudiante2 = Estudiante.builder() // Crea un estudiante usando el patrón builder
                .nombre("Alejandro") // Asigna el nombre
                .apellido("Cruz") // Asigna el apellido
                .email("ale.perez@example.com") // Asigna el email
                .fechaNacimiento(LocalDate.of(2000, 11, 15)) // Asigna la fecha de nacimiento
